...
"""
madrasafree-services documentation build configuration file.
...
project = 'madrasafree-services'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'madrasafree-services'
...
#
# html_title = 'madrasafree-services v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Services that extends Open edX platform for madrasafree usage',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'madrasafree_services'),
                os.path.join(root_path, 'madrasafree_services/migrations')])
