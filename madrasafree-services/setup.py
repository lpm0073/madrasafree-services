...
VERSION = get_version('madrasafree_services', '__init__.py')
...
setup(
    ...
    entry_points={
        "lms.djangoapp": [
            'madrasafree_services_plugin = madrasafree_services_plugin.apps:MadrasafreeServicesConfigPlugin'
        ]
    }
)
